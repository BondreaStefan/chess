...
/**
 * Reads the 64 reed switches through four CD74HC4067 multiplexers and reports
 * which squares are occupied. Owns the Pi4J context and GPIO pins, so exactly
 * one instance must exist and be shared by every component that reads the board.
 */
public class BoardScanner
{
    ...
    /** Returns an 8x8 grid of occupancy: true where a piece (magnet) is present. */
    public boolean[][] scan()
    {
